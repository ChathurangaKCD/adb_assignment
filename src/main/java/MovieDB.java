...
class MovieDB
{
    ...
    public static void main (String [] args)
    {
        ...
        final Table cinema = new Table ("cinema", "title year length genre studioName producerNo",
                                            "String Integer Integer String String Integer", "title year");

        final Table movieStar = new Table ("movieStar", "name address gender birthdate",
                                                  "String String Character String", "name");

        final Table starsIn = new Table ("starsIn", "movieTitle movieYear starName",
                                              "String Integer String", "movieTitle movieYear starName");

        final Table movieExec = new Table ("movieExec", "certNo name address fee",
                                                  "Integer String String Float", "certNo");

        final Table studio = new Table ("studio", "name address presNo",
